...
PLAT_DEPENDENT_LIB_EX = -lmi_disp -lmi_panel  -lmi_vdec -lmi_divp -lmi_ao 
...
# Standard libraries
STDLIBS = -ldl -lm -lmad -lz -lpthread -lmi_common -lmi_sys -lmi_wlan -lcjson -Wl,--hash-style=gnu 
STDLIBS += -lavformat -lavcodec -lavutil -lswscale -lswresample -lcrypto -lssl -lssplayer 
...
default: $(AOBJS) $(COBJS) $(MAINOBJ)
	...
	arm-linux-gnueabi-strip ./bin/demossd
	scp ./bin/demossd root@192.168.11.120:~/
clean:
	rm -f $(BIN)
	rm -rf $(OBJDIR) ./bin/*
